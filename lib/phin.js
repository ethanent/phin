...
* @property {boolean} [stream=false] - Injects the 'stream' property into the response object and removes the 'body' property from the response object
* @property {boolean} [compressed=false] - Enable compression for request
...
* @param {?http.serverResponse} phinResponse - phin response object. Like <a href='https://nodejs.org/api/http.html#http_class_http_serverresponse'>http.ServerResponse</a> but has a 'body' property containing the response body (unless the 'stream' property is enabled) and a 'stream' property containing the response stream (if the 'stream' property is enabled)
*/
