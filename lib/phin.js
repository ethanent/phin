 ...
 * @property {Object=} headers An object with request headers. Defaults to sending a 'Accept-Encoding' header with the value 'gzip, deflate'.
...
if (util.promisify) {
	phin[util.promisify.custom] = (opts) => {
